...
public class MojeZdjeciaAction extends ActionSupport  implements SessionAware {
    ...
    public void setPicturesList(long idUser){
    	...
    	picturesList = DAO.getUserPicturesData(idUser, Long.parseLong(id)); //id_user, id_album
    ...
    public boolean check(){
    	...
    	List<Album> tmp1 = DAO.getIdEventHavingIdAlbum(Long.parseLong(id));
    	...
    	List<User> tmp = DAO.getTworcaEventu(Id_Event);
